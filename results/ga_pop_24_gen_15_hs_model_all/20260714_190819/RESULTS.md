...
_Generated 20260714_190819 by `scripts/ga_search.py` (pymoo 0.6.2)._
...
| metric | seconds |
|---|---|
| run wall clock | 1632.07 |
| UNO time (sum of tic-toc) | 9779.38 |
| **GA overhead** | **-8147.32** |

- GA overhead is -499.2% of the run wall
  clock. Distinct configs solved (UNO calls): 189; total GA
...
|---|---|---|---|
| filtersqp | 0.9669 | 19.190 | 1.0350 |
| ipopt | 0.9256 | 5.110 | 1.0171 |
...
|---|---|---|---|---|---|---|---|---|
| feasibility_restoration | interior_point | exact | primal_dual | LS | funnel_method | 0.9669 | 4.906 | 1.0588 |

- vs **filtersqp**: reliability 0.9669 vs 0.9669  ·  time 4.906s vs 19.190s  ·  score 1.0588 vs 1.0350
- vs **ipopt**: reliability 0.9669 vs 0.9256  ·  time 4.906s vs 5.110s  ·  score 1.0588 vs 1.0171
...
- Distinct configs evaluated: **189** of 240 nominal
