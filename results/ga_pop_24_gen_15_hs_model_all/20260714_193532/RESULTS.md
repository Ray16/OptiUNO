...
_Generated 20260714_193532 by `scripts/ga_search.py` (pymoo 0.6.2)._
...
| metric | seconds |
|---|---|
| run wall clock | 2883.53 |
| UNO time (sum of tic-toc) | 9740.76 |
| **GA overhead** | **-6857.23** |

- GA overhead is -237.8% of the run wall
  clock. Distinct configs solved (UNO calls): 195; total GA
...
|---|---|---|---|
| filtersqp | 0.9669 | 10.555 | 1.0494 |
| ipopt | 0.9256 | 3.153 | 1.0204 |
...
|---|---|---|---|---|---|---|---|---|
| feasibility_restoration | interior_point | exact | primal_dual | LS | funnel_method | 0.9669 | 2.953 | 1.0620 |

- vs **filtersqp**: reliability 0.9669 vs 0.9669  ·  time 2.953s vs 10.555s  ·  score 1.0620 vs 1.0494
- vs **ipopt**: reliability 0.9669 vs 0.9256  ·  time 2.953s vs 3.153s  ·  score 1.0620 vs 1.0204
